...
const STEPS = ['Account', 'Secret Image', 'Face Scan', 'Authenticator'];
...
export default function RegisterPage() {
  ...
  async function handleCredentials(e) {
    ...
    if (!imageHash) return setError('Please select your secret image first.');
    ...
    try {
      ...
      setStep(2); // skip to face scan; TOTP comes last
    } catch (err) {
  ...
  return (
    <div className="auth-page">
      <div className="auth-card">
        ...
        {/* ── STEP 0 + 1: Credentials + Image (shown together) ── */}
        {step === 0 && (
